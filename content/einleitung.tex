...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{figures/tapyre-logo.png}
	\caption{Logo des Systems Tapyre}
	\label{fig:tapyre-logo}
\end{figure}
