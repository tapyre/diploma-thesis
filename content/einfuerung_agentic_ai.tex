...
\begin{enumerate}
    \item Retrieval: Suche nach relevanten Dokumenten, z.\,B. über Vektorsuche in Qdrant.
    \item Generation: Erzeugung einer Antwort mithilfe des Sprachmodells, unter Nutzung der gefundenen Informationen.
\end{enumerate}
