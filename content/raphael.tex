...
Diese \texttt{PaperSearch}-Komponente wiederum komponiert ihre Oberfläche aus kleineren, spezialisierten Bausteinen wie der \texttt{InputGroup}, die das Eingabefeld und die Buttons enthält, und den \texttt{DropdownMenu}-Komponenten zur Auswahl der Suchoptionen. Dieses Prinzip der Komposition, bei dem komplexe Funktionalität durch das Zusammensetzen einfacher, testbarer Teile entsteht, ist ein Eckpfeiler der React-Entwicklung, wie im folgenden Code-Ausschnitt ersichtlich ist.
