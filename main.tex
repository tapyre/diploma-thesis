...
\newcommand{\mysubtitle}{Agentic AI und semantische Literaturrecherche – Konzeption und Implementierung zweier KI-gestützter Systeme}
...
\include{content/ki_einsatz}       %% KI Einsatz
...
\input{content/einfuehrung_neuronale_netzwerke}
\input{content/einfuehrung_nlp}
\input{content/einfuerung_agentic_ai}
\input{content/verwendeten_technologien}
\input{content/entwicklung_tapyre}
\input{content/entwicklung_tapyre_paper_search}
\input{content/raphael.tex}
\input{content/zusammenfassung.tex}

\appendix                       %% closes main document, appendix follows until end; only available in book-classes

\addpart*{Appendix}             %% adding Appendix to tableofcontents
\input{content/zeiterfassung.tex}
